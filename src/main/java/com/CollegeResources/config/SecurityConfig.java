...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://pecportal.me","https://www.pecportal.me","https://pecportal.vercel.app", "http://localhost:5173"));// Allow React frontend
//        config.setAllowedOrigins(List.of("http://localhost:5173"));
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring()
                .requestMatchers("/api/materials/direct-download/**")
                .requestMatchers("/api/materials/view/**");
